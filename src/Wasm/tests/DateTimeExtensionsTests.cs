...
public class DateTimeExtensionsTests(ITestOutputHelper output)
{
    ...
    public class FormatTheoryData : TheoryData<FormatTestCase>
    {
        ...
        {
            AddRange(
                new FormatTestCase("am/pm", "3pm", "9pm"),
                new("AM/PM", "3PM", "9PM"),
        ...
        public ParseTheoryData()
        {
            AddRange(
                ...
                new(
                    ...
                    new(
                        2010, 2, 4, 21, 0, 57, 0,
                        TimeZoneInfoExtensions.FindSystemTimeZoneByIdOrAbbr("PST").BaseUtcOffset
                        )
                    ), new(
                    "UnixDate F",
                    DateTimeExtensions.UnixDate,
                ...
                new(
                    ...
                    new(
                        2010, 2, 4, 22, 0, 57, 0,
                        TimeZoneInfoExtensions.FindSystemTimeZoneByIdOrAbbr("America/Los_Angeles").BaseUtcOffset
                        )
                    ),
                new(
                    "RFC1123 PST F",
