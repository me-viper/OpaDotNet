...
internal sealed class CompositeImportsHandler : IOpaImportsAbi
{
    ...
    /// <param name="isAsync">Built-ins are async</param>
        ...
        bool isAsync)
    {
        ...
        _importsCache.Populate(_imports, isAsync);
    ...
    private object? TryCall(BuiltinContext context, BuiltinArg[] args)
    {
        ...
        try
        {
            ...
            var callContext = new OpaCustomBuiltinsContext
            {
            ...
            object? RunAndWait()
            {
                // Maybe we could use custom SynchronizationContext here.
                // This makes expression trees generated by ImportCache more lightweight and lets us
            ...
            if (attributes!.Memorize)
            {
                ...
                return _valueCache.GetOrAdd(callHash, _ => RunAndWait());
            }
