    ...
    public virtual object? Func(BuiltinContext context, BuiltinArg arg1)
    {
        try
        {
            return context.FunctionName switch
            {
                ...
                "time.date" => Date(arg1.Raw),
                "time.clock" => Clock(arg1.Raw),
                "time.weekday" => Weekday(arg1.Raw),
                "time.parse_rfc3339_ns" => ParseRfc3339Ns(arg1.As<string>()),
                "time.parse_duration_ns" => ParseDurationNs(arg1.As<string>()),
                "time.format" => TimeFormat(arg1.RawJson),
                "uuid.rfc4122" => NewGuid(arg1.As<string>()),
                "uuid.parse" => UuidParse(arg1.As<string>()),
                ...
                "crypto.x509.parse_rsa_private_key" => X509ParseRsaPrivateKey(arg1.As<string>()),
                ...
                "uri.is_valid" => UriIsValid(arg1.As<string>()),
                "uri.parse" => UriParse(arg1.As<string>()),
    ...
    public virtual object? Func(BuiltinContext context, BuiltinArg arg1, BuiltinArg arg2)
    {
        try
        {
            return context.FunctionName switch
            {
                ...
                "strings.any_prefix_match" => AnyPrefixMatch(arg1.RawJson, arg2.RawJson),
                "strings.any_suffix_match" => AnySuffixMatch(arg1.RawJson, arg2.RawJson),
                "strings.count" => StringCount(arg1.As<string>(), arg2.As<string>()),
                "time.diff" => Diff(arg1.Raw, arg2.Raw),
                ...
                "crypto.x509.parse_keypair" => X509ParseKeypair(arg1.As<string>(), arg2.As<string>()),
